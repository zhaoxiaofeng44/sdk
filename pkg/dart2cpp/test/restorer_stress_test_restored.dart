...
void main() {
  ...
  staticPrint('\n--- 11. 集合操作 ---');
  final DataPipelineValue<int> pipeline = (() { final _r11 = (() { final _r10 = (() { final _r9 = (() { final _r8 = DataPipeline_new<int>(GC.allocateLocal(DataPipelineValue<int>()), StaticList<int>.of([5, 3, 8, 1, 9, 2, 7, 4, 6])); return (_r8.vptr['where'] as DataPipelineValue<int> Function(dynamic, TypeFunction1<bool, int>))(_r8, ClosureEnv_main_21_new(GC.allocateLocal(ClosureEnv_main_21()))); })(); return (_r9.vptr['sorted'] as DataPipelineValue<int> Function(dynamic, TypeFunction2<int, int, int>))(_r9, ClosureEnv_main_23_new(GC.allocateLocal(ClosureEnv_main_23()))); })(); return (_r10.vptr['take'] as DataPipelineValue<int> Function(dynamic, int))(_r10, 5); })(); return (_r11.vptr['map_int'] as DataPipelineValue<int> Function(dynamic, TypeFunction1<int, int>))(_r11, ClosureEnv_main_25_new(GC.allocateLocal(ClosureEnv_main_25()))); })();
  staticPrint('pipeline: ${(pipeline.vptr['toList'] as StaticList<int> Function(dynamic))(pipeline)}');
  final int pipeSum = (() { final _r12 = DataPipeline_new<int>(GC.allocateLocal(DataPipelineValue<int>()), StaticList<int>.of([1, 2, 3, 4, 5])); return (_r12.vptr['fold_int'] as int Function(dynamic, int, TypeFunction2<int, int, int>))(_r12, 0, ClosureEnv_main_27_new(GC.allocateLocal(ClosureEnv_main_27()))); })();
