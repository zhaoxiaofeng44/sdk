...
mixin _DeclarationRestorer on _DartRestorerBase, _TypeUtils, _ExpressionRestorer, _StatementRestorer {
  ...
  void _emitSuperInit(SuperInitializer init, String? parentName, String className) {
    ...
    final prefix = init.target.enclosingClass != null
        ? _crossLibPrefixForClass(init.target.enclosingClass!)
        : _crossLibPrefix(actualParent);
  ...
  String _paramTypeForDefault(DartType type, String? defaultExpr) {
    final restored = _restoreType(type);
