...
return Void;
  ...
  _Musician_Performer_Singing(String name) : Performer(name) {
  }
...
return Void;
  ...
  _Musician_Performer_Singing_Playing(String name) : _Musician_Performer_Singing(name) {
  }
...
return Void;
  ...
  _Dancer_Performer_Dancing(String name) : Performer(name) {
  }
...
return Void;
  ...
  _Artist_Performer_Singing(String name) : Performer(name) {
  }
...
return Void;
  ...
  _Artist_Performer_Singing_Playing(String name) : _Artist_Performer_Singing(name) {
  }
...
return Void;
  ...
  _Artist_Performer_Singing_Playing_Dancing(String name) : _Artist_Performer_Singing_Playing(name) {
  }
...
return Void;
  ...
  _Artist_Performer_Singing_Playing_Dancing_Painting(String name) : _Artist_Performer_Singing_Playing_Dancing(name) {
  }
...
return MathExtensions::sqrt(s->operator_mul(s->operator_sub(this->a))->operator_mul(s->operator_sub(this->b))->operator_mul(s->operator_sub(this->c))->abs());
  }
...
public:
  ObjectPtr<Weekday> monday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> tuesday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> wednesday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> thursday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> friday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> saturday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<Weekday> sunday = ObjectPtr<Weekday>(new Weekday());
  ObjectPtr<List<ObjectPtr<Weekday>>> values = List<ObjectPtr<Weekday>>::createConst({ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday())});
  ...
  Bool isWeekend() {
    return (this->isWeekday()).operator_not();
  }
...
public:
  ObjectPtr<Color> red = ObjectPtr<Color>(new Color());
  ObjectPtr<Color> green = ObjectPtr<Color>(new Color());
  ObjectPtr<Color> blue = ObjectPtr<Color>(new Color());
  Int rgb;
  ObjectPtr<List<ObjectPtr<Color>>> values = List<ObjectPtr<Color>>::createConst({ObjectPtr<Color>(new Color()), ObjectPtr<Color>(new Color()), ObjectPtr<Color>(new Color())});
...
public:
  ObjectPtr<OrderStatus> pending = ObjectPtr<OrderStatus>(new OrderStatus());
  ObjectPtr<OrderStatus> processing = ObjectPtr<OrderStatus>(new OrderStatus());
  ObjectPtr<OrderStatus> shipped = ObjectPtr<OrderStatus>(new OrderStatus());
  ObjectPtr<OrderStatus> delivered = ObjectPtr<OrderStatus>(new OrderStatus());
  ObjectPtr<List<ObjectPtr<OrderStatus>>> values = List<ObjectPtr<OrderStatus>>::createConst({ObjectPtr<OrderStatus>(new OrderStatus()), ObjectPtr<OrderStatus>(new OrderStatus()), ObjectPtr<OrderStatus>(new OrderStatus()), ObjectPtr<OrderStatus>(new OrderStatus())});
...
public:
  ...
  static ObjectPtr<Student> withGrade(String name, Int age, String studentId, String grade) {
    auto obj = ObjectPtr<Student>(new Student());
    obj->name = name;
    obj->age = age;
    obj->studentId = studentId;
    obj->grade = grade;
    obj->isGraduate = dart_bool(false);
    return obj;
  }
  
  static ObjectPtr<Student> graduate(String name, Int age) {
    auto obj = ObjectPtr<Student>(new Student());
    obj->name = name;
    obj->age = age;
    obj->studentId = dart_string("GRAD");
    obj->grade = Null;
    obj->isGraduate = dart_bool(true);
    return obj;
  }
...
private:
  ...
  static ObjectPtr<Logger> _internal(String name) {
    auto obj = ObjectPtr<Logger>(new Logger());
    obj->name = name;
    return obj;
  }
  
  static ObjectPtr<Logger> create(String name) {
    return Logger::_cache->putIfAbsent(name, makeFunction<ObjectPtr<Logger>>(std::function<ObjectPtr<Logger>()>([=]() -> ObjectPtr<Logger> { return ObjectPtr<Logger>(new Logger(name)); })));
  }
...
public:
  ...
  static ObjectPtr<Point> fromList(ObjectPtr<List<Double>> coords) {
    auto obj = ObjectPtr<Point>(new Point());
    return obj;
  }
...
Double MathExtensions::sqrt(Double this_);
Nullable testBasicClasses() {
...
auto sync_for_iterator_1 = animals->iterator();
for (; sync_for_iterator_1->hasNext(); ) {
auto animal = sync_for_iterator_1->next();
animal->makeSound();
animal->move();
...
auto sync_for_iterator_2 = vehicles->iterator();
for (; sync_for_iterator_2->hasNext(); ) {
auto vehicle = sync_for_iterator_2->next();
vehicle->start();
vehicle->stop();
...
auto sync_for_iterator_3 = shapes->iterator();
for (; sync_for_iterator_3->hasNext(); ) {
auto shape = sync_for_iterator_3->next();
...
Nullable testEnums() {
  dart_print(dart_string("\n📌 测试枚举"));
auto today = ObjectPtr<Weekday>(new Weekday());
...
auto sync_for_iterator_4 = List<ObjectPtr<Weekday>>::createConst({ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday()), ObjectPtr<Weekday>(new Weekday())})->iterator();
for (; sync_for_iterator_4->hasNext(); ) {
auto day = sync_for_iterator_4->next();
dart_print(dart_concat(dart_string("    "), (EnumName::get_name(day)).toString(), dart_string(" (索引: "), (day->index).toString(), dart_string(")")));
}
auto red = ObjectPtr<Color>(new Color());
auto green = ObjectPtr<Color>(new Color());
auto blue = ObjectPtr<Color>(new Color());
...
auto status = ObjectPtr<OrderStatus>(new OrderStatus());
dart_print(dart_string("  订单状态测试:"));
if (status == ObjectPtr<OrderStatus>(new OrderStatus())) {
  dart_print(dart_string("    订单状态: 待处理"));
} else if (status == ObjectPtr<OrderStatus>(new OrderStatus())) {
...
dart_print(dart_string("  工厂构造函数: 同一实例? ") + (dart_identical(logger1, logger2)).toString());
