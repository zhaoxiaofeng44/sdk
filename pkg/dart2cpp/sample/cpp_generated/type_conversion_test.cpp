...
Any value3 = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3));
...
unknownValue = _GrowableList::_literal5(dart_int(1), dart_int(2), dart_int(3), dart_int(4), dart_int(5));
...
auto mixedList = _GrowableList::_literal4(dart_int(1), dart_string("hello"), _GrowableList::_literal2(dart_int(1), dart_int(2)), Map<String, String>::createFromEntries({{dart_string("key"), dart_string("value")}}));
...
auto list = _GrowableList::_literal5(dart_int(1), dart_int(2), dart_int(3), dart_int(4), dart_int(5));
...
dynamicVar = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3));
...
Any listDynamic = _GrowableList::_literal5(dart_int(1), dart_int(2), dart_int(3), dart_int(4), dart_int(5));
...
auto dynamicList = _GrowableList::_literal5(dart_int(1), dart_int(2), dart_int(3), dart_int(4), dart_int(5));
...
auto numList = _GrowableList::_literal5(dart_int(1), dart_double(2.5), dart_int(3), dart_double(4.7), dart_int(5));
...
auto objectList = _GrowableList::_literal4(dart_int(1), dart_string("hello"), dart_double(3.14), dart_bool(true));
...
auto dogList = _GrowableList::_literal2(ObjectPtr<Dog>(new Dog(dart_string("Buddy"))), ObjectPtr<Dog>(new Dog(dart_string("Max"))));
...
template<typename T>
ObjectPtr<List<T>> createList(T first, T second) {
  return _GrowableList::_literal2(first, second);
}
