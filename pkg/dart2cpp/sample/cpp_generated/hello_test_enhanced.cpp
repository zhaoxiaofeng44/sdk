...
// ============================================================================
// 类: _Bird_Object_Flyable
// ============================================================================

class _Bird_Object_Flyable : virtual public Flyable {
public:
  virtual ~_Bird_Object_Flyable() = default;
...
// ============================================================================
// 类: _Bird_Object_Flyable_Speakable
// ============================================================================

class _Bird_Object_Flyable_Speakable : public _Bird_Object_Flyable, virtual public Speakable {
public:
  virtual ~_Bird_Object_Flyable_Speakable() = default;
  
  template<typename... Args>
  _Bird_Object_Flyable_Speakable(Args&&... args) : _Bird_Object_Flyable(std::forward<Args>(args)...) {}
...
class Bird : public _Bird_Object_Flyable_Speakable {
public:
  String name;
...
Nullable testEnhancedFunctions() {
  dart_print(dart_string("\n--- 增强函数 ---"));
auto greet = [&](String name, String greeting) { return dart_concat((greeting).toString(), dart_string(", "), (name).toString(), dart_string("!")); };
auto createProfile = [&]() { auto profile = dart_string("姓名: ") + (name).toString();
if (!(dart_is_null(age))) {
...
return profile; };
auto calculate = [&](Int a, Int b, ObjectPtr<TypedFunction<std::function<Int(Int, Int)>, Int, Int, Int>> operation) { return operation->call(a, b); };
...
Person::logCreation();
dart_print(dart_string("人员姓名: ") + (person->get_name()).toString());
person->set_name(dart_string("李四"));
dart_print(dart_string("更新后姓名: ") + (person->get_name()).toString());
...
throw DartException(Exception::create(dart_string("年龄不能为负数")));
}
