...
auto mixed = _GrowableList::_literal4(dart_int(1), dart_string("hello"), dart_bool(true), dart_double(3.14));
auto emptyList = _GrowableList::create(dart_int(0));
...
numbers->insertAll(dart_int(2), _GrowableList::_literal2(dart_int(11), dart_int(12)));
...
auto unsorted = _GrowableList::_literal6(dart_int(5), dart_int(2), dart_int(8), dart_int(1), dart_int(9), dart_int(3));
unsorted->sort();
dart_print(dart_string("  排序后: ") + (unsorted).toString());
auto words = _GrowableList::_literal4(dart_string("banana"), dart_string("apple"), dart_string("cherry"), dart_string("date"));
...
auto colors = ([&]() { const auto unnamed_var = ObjectPtr<Set<String>>(new Set<String>()); unnamed_var->add(dart_string("red")); unnamed_var->add(dart_string("green")); unnamed_var->add(dart_string("blue")); return unnamed_var; })();
...
numbers->add(dart_int(6));
numbers->addAll(_GrowableList::_literal4(dart_int(7), dart_int(8), dart_int(3), dart_int(4)));
dart_print(dart_string("  添加元素后: ") + (numbers).toString());
...
auto duplicates = ([&]() { const auto unnamed_var = ObjectPtr<Set<Int>>(new Set<Int>()); unnamed_var->add(dart_int(1)); unnamed_var->add(dart_int(1)); unnamed_var->add(dart_int(2)); unnamed_var->add(dart_int(2)); unnamed_var->add(dart_int(3)); unnamed_var->add(dart_int(3)); unnamed_var->add(dart_int(4)); unnamed_var->add(dart_int(4)); return unnamed_var; })();
...
auto person = Map<String, Any>::createFromEntries({{dart_string("name"), dart_string("John")}, {dart_string("age"), dart_int(30)}, {dart_string("isStudent"), dart_bool(false)}, {dart_string("hobbies"), _GrowableList::_literal2(dart_string("reading"), dart_string("swimming"))}});
...
auto product = _GrowableList::_literal4(dart_int(1), dart_int(2), dart_int(3), dart_int(4))->reduce(makeFunction([&](Int a, Int b) { return a->operator_mul(b); }));
...
auto concatenated = _GrowableList::_literal3(dart_string("a"), dart_string("b"), dart_string("c"))->fold(dart_string(""), makeFunction([&](String prev, String element) { return prev->operator_add(element); }));
...
auto expanded = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3))->expand(makeFunction([&](Int n) { return _GrowableList::_literal2(n, n->operator_mul(dart_int(10))); }))->toList();
auto words = _GrowableList::_literal2(dart_string("hello"), dart_string("world"))->expand(makeFunction([&](String word) { return word->split(dart_string("")); }))->toList();
...
Nullable testCollectionLiterals() {
  dart_print(dart_string("\n📌 测试集合字面量"));
auto emptyList = _GrowableList::create(dart_int(0));
auto numberList = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3));
auto stringList = _GrowableList::_literal3(dart_string("a"), dart_string("b"), dart_string("c"));
auto mixedList = _GrowableList::_literal3(dart_int(1), dart_string("hello"), dart_bool(true));
...
auto emptySet = ([&]() { const auto unnamed_var = ObjectPtr<Set<Int>>(new Set<Int>()); return unnamed_var; })();
auto numberSet = ([&]() { const auto unnamed_var = ObjectPtr<Set<Int>>(new Set<Int>()); unnamed_var->add(dart_int(1)); unnamed_var->add(dart_int(2)); unnamed_var->add(dart_int(3)); unnamed_var->add(dart_int(2)); unnamed_var->add(dart_int(1)); return unnamed_var; })();
auto stringSet = ([&]() { const auto unnamed_var = ObjectPtr<Set<String>>(new Set<String>()); unnamed_var->add(dart_string("x")); unnamed_var->add(dart_string("y")); unnamed_var->add(dart_string("z")); return unnamed_var; })();
...
auto mixedMap = Map<String, Any>::createFromEntries({{dart_string("name"), dart_string("John")}, {dart_string("age"), dart_int(30)}, {dart_string("scores"), _GrowableList::_literal3(dart_int(95), dart_int(87), dart_int(92))}});
...
auto list1 = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3));
auto list2 = _GrowableList::_literal3(dart_int(4), dart_int(5), dart_int(6));
auto combined = ([&]() { const auto unnamed_var = List::of(list1, dart_bool(true)); unnamed_var->addAll(list2); return unnamed_var; })();
auto withExtra = ([&]() { const auto unnamed_var = _GrowableList::_literal1(dart_int(0)); unnamed_var->addAll(list1); unnamed_var->add(dart_int(99)); unnamed_var->addAll(list2); unnamed_var->add(dart_int(100)); return unnamed_var; })();
...
auto conditionalList = ([&]() { const auto unnamed_var = _GrowableList::_literal3(dart_int(1), dart_int(2), dart_int(3)); if (includeExtra) {
unnamed_var->addAll(_GrowableList::_literal3(dart_int(4), dart_int(5), dart_int(6)));
...
auto repeated = ([&]() { const auto unnamed_var = _GrowableList::create(dart_int(0)); for (auto i = dart_int(0); i->operator_less(dart_int(3)); i = i->operator_add(dart_int(1))) {
...
Nullable testIterations() {
  dart_print(dart_string("\n📌 测试集合迭代"));
auto fruits = _GrowableList::_literal4(dart_string("apple"), dart_string("banana"), dart_string("orange"), dart_string("grape"));
auto numbers = ([&]() { const auto unnamed_var = ObjectPtr<Set<Int>>(new Set<Int>()); unnamed_var->add(dart_int(1)); unnamed_var->add(dart_int(2)); unnamed_var->add(dart_int(3)); unnamed_var->add(dart_int(4)); unnamed_var->add(dart_int(5)); return unnamed_var; })();
auto scores = Map<String, Int>::createFromEntries({{dart_string("Alice"), dart_int(95)}, {dart_string("Bob"), dart_int(87)}, {dart_string("Charlie"), dart_int(92)}});
