...
dart_print(dart_concat(dart_string("  多行字符串长度: "), multiLine.get_length()));
return Void;
}
...
auto nonNull = dart_is_null(nullableString) ? dart_string("default") : nullableString;
...
String nullable;
auto safe = dart_is_null(nullable) ? dart_string("default value") : nullable;
...
dart_print(dart_concat(dart_string("    长度: "), str1.get_length()));
