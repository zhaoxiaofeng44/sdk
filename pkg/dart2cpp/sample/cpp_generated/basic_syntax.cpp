...
auto expression = dart_string("Sum: ") + (intValue->operator_add(doubleValue)).toString();
...
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" + "), (b).toString(), dart_string(" = "), (a->operator_add(b)).toString()));
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" - "), (b).toString(), dart_string(" = "), (a->operator_sub(b)).toString()));
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" * "), (b).toString(), dart_string(" = "), (a->operator_mul(b)).toString()));
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" / "), (b).toString(), dart_string(" = "), (a->operator_div(b)).toString()));
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" % "), (b).toString(), dart_string(" = "), (a->operator_mod(b)).toString()));
...
dart_print(dart_concat(dart_string("    "), (a).toString(), dart_string(" <= "), (b).toString(), dart_string(": "), (a->operator_less_equals(b)).toString()));
...
if (score->operator_greater_equals(dart_int(70))) {
...
while (count->operator_less(dart_int(3))) {
dart_print(dart_string("    计数: ") + (count).toString());
count = count->operator_add(dart_int(1));
}
dart_print(dart_string("  do-while 循环测试:"));
auto num = dart_int(0);
do {
dart_print(dart_string("    数字: ") + (num).toString());
num = num->operator_add(dart_int(1));
} while ((num->operator_less(dart_int(3))).toBool());
dart_print(dart_string("  break 和 continue 测试:"));
for (auto i = dart_int(0); i->operator_less(dart_int(10)); i = i->operator_add(dart_int(1))) {
if ((i == dart_int(2))) {
break;
}
if ((i == dart_int(7))) {
...
auto concat = str1->operator_add(dart_string(" "))->operator_add(str2);
...
auto expression = dart_string("Sum: ") + (dart_int(10)->operator_add(dart_int(20))).toString();
