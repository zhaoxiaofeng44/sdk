...
dart_print(dart_string("    5 + 0 = ") + ((dart_int(5) + dart_int(0))).toString());
dart_print(dart_string("    5 * 0 = ") + ((dart_int(5) * dart_int(0))).toString());
dart_print(dart_string("    5 - 0 = ") + ((dart_int(5) - dart_int(0))).toString());
dart_print(dart_string("    0 - 5 = ") + ((dart_int(0) - dart_int(5))).toString());
dart_print(dart_string("  负数运算:"));
dart_print(dart_string("    -5 + (-3) = ") + ((dart_int(-5) + dart_int(-3))).toString());
dart_print(dart_string("    -5 * -3 = ") + ((dart_int(-5) * dart_int(-3))).toString());
dart_print(dart_string("    -5 - (-3) = ") + ((dart_int(-5) - dart_int(-3))).toString());
...
dart_print(dart_concat(dart_string("    substring(0,0): \""), (sub1).toString(), dart_string("\""))); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try auto sub2 = str.substring(dart_int(0), str.size());
dart_print(dart_concat(dart_string("    substring(0,len): \""), (sub2).toString(), dart_string("\""))); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try auto sub3 = str.substring(str.size(), str.size());
dart_print(dart_concat(dart_string("    substring(len,len): \""), (sub3).toString(), dart_string("\""))); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
...
try dart_print(dart_string("    first: ") + (emptyList->first()).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try dart_print(dart_string("    last: ") + (emptyList->last()).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
...
try dart_print(dart_string("    索引0: ") + (testList->get(dart_int(0))).toString());
dart_print(dart_string("    索引-1: ") + (testList->get(dart_int(-1))).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try dart_print(dart_string("    索引3: ") + (testList->get(dart_int(3))).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
...
dart_print(dart_string("    访问不存在键: ") + (emptyMap->get(dart_string("nonexistent"))).toString());
...
dart_print(dart_string("    不会执行到这里: ") + (crashString).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
}
...
dart_print(dart_string("    10 ~/ 0 = ") + (result).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
...
dart_print(dart_string("    10 % 0 = ") + (mod1).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
dart_print(dart_string("    10 % 3 = ") + ((dart_int(10) % dart_int(3))).toString());
dart_print(dart_string("    10 % -3 = ") + ((dart_int(10) % dart_int(-3))).toString());
dart_print(dart_string("    -10 % 3 = ") + ((dart_int(-10) % dart_int(3))).toString());
dart_print(dart_string("    -10 % -3 = ") + ((dart_int(-10) % dart_int(-3))).toString());
...
dart_print(dart_string("    infinity + 1: ") + ((inf + dart_int(1))).toString());
dart_print(dart_string("    infinity - infinity: ") + ((inf - inf)).toString());
dart_print(dart_string("    infinity / infinity: ") + ((inf / inf)).toString());
dart_print(dart_string("    infinity * 0: ") + ((inf * dart_int(0))).toString());
return Void;
}
...
try auto parsed1 = int::parse(dart_string("123"), Int(Null), std::function<Int(String)>(Null));
dart_print(dart_string("    parse \"123\": ") + (parsed1).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try auto parsed2 = int::parse(dart_string(""), Int(Null), std::function<Int(String)>(Null));
dart_print(dart_string("    parse 空字符串: ") + (parsed2).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try auto parsed3 = int::parse(dart_string("abc"), Int(Null), std::function<Int(String)>(Null));
dart_print(dart_string("    parse \"abc\": ") + (parsed3).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
...
dart_print(dart_string("    42 as int: ") + (intValue).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
try auto intValue = dart_cast<Int>(value2);
dart_print(dart_string("    \"hello\" as int: ") + (intValue).toString()); catch (const std::exception& e) { /* catch block */ }
// Finally block should be implemented using RAII pattern
