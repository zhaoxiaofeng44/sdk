...
auto result3 = dart_is<String>(obj1) && dart_is<Int>(obj2) ? dart_print(dart_concat((obj1->get_length()).toString(), dart_string(" and "), (obj2).toString())) : dart_print(dart_string("Type mismatch"));
auto animal3 = ObjectPtr<Dog>(new Dog(dart_string("Buddy"), dart_string("Golden Retriever")));
auto result4 = dart_is<ObjectPtr<Dog>>(animal3) && dart_cast<ObjectPtr<Dog>>(animal3)->breed->get_length()->operator_greater(dart_int(5)) && dart_cast<ObjectPtr<Dog>>(animal3)->name->get_length()->operator_greater(dart_int(3)) ? dart_print(dart_string("Long breed name: ") + (animal3->breed).toString()) : dart_print(dart_string("Short name"));
