...
auto mixed = dart_literal<Int>(dart_int(1), dart_string("hello"), dart_bool(true), dart_double(3.14));
...
auto mixedList = dart_literal<Int>(dart_int(1), dart_string("hello"), dart_bool(true));
