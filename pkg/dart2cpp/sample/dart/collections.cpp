...
auto mixed = dart_literal<Any>(dart_int(1), dart_string("hello"), dart_bool(true), dart_double(3.14));
...
numbers->insertAll(dart_int(2), dart_literal<Int>(dart_int(11), dart_int(12)));
...
auto unsorted = dart_literal<Int>(dart_int(5), dart_int(2), dart_int(8), dart_int(1), dart_int(9), dart_int(3));
unsorted->sort();
...
numbers->add(dart_int(6));
numbers->addAll(dart_literal<Int>(dart_int(7), dart_int(8), dart_int(3), dart_int(4)));
dart_print(dart_string("  添加元素后: ") + (numbers).toString());
...
auto stringList = dart_literal<String>(dart_string("a"), dart_string("b"), dart_string("c"));
auto mixedList = dart_literal<Any>(dart_int(1), dart_string("hello"), dart_bool(true));
...
auto withExtra = ([&]() { const auto unnamed_var = dart_literal<Int>(); unnamed_var->addAll(list1); unnamed_var->add(dart_int(99)); unnamed_var->addAll(list2); unnamed_var->add(dart_int(100)); return unnamed_var; })();
...
auto conditionalList = ([&]() { const auto unnamed_var = dart_literal<Int>(dart_int(1), dart_int(2), dart_int(3)); if (includeExtra) {
unnamed_var->addAll(dart_literal<Int>(dart_int(4), dart_int(5), dart_int(6)));
...
auto repeated = ([&]() { const auto unnamed_var = dart_literal<Int>(); for (auto i = dart_int(0); i->operator_less(dart_int(3)); i = i->operator_add(dart_int(1))) {
