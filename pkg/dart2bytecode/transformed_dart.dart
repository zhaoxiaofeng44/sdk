...
class CppList<E> extends CppIterable<E> implements List<E> {
        ...
        for (; _sync_for_iterator.moveNext();) {
          {
            dynamic? element = _sync_for_iterator.current;
            {
              CppApi.cppSetPointerArrayItem(array, (() {
                final int temp_1268_2190 = i;
                return (() {
                  final int temp_1268_2194 = i = (temp_1268_2190 + 1);
                  return temp_1268_2190;
                })();
              })(), element);
            }
          }
  ...
  factory CppList.generate(int length, E Function(int) generator,
      {bool growable = true}) {
    {
      CppUserData array = growable
          ? CppApi.cppCreatePointerArray(length)
        ...
        for (; _sync_for_iterator.moveNext();) {
          {
            ...
            {
              CppApi.cppSetPointerArrayItem(array, (() {
                final int temp_2097_2286 = i;
                return (() {
                  final int temp_2097_2290 = i = (temp_2097_2286 + 1);
                  return temp_2097_2286;
                })();
              })(), element as E);
            }
          }
  ...
  void add(E value) {
    {
      ...
      CppApi.cppSetPointerArrayItem(this._array, (() {
        final int temp_3193_2443 = this._length;
        return (() {
          final int temp_3186_2448 = this._length = (temp_3193_2443 + 1);
          return temp_3193_2443;
        })();
      })(), value);
    }
  }
      ...
      for (int i = start; (i < end); i = (i + 1)) {
        {
          CppApi.cppSetPointerArrayItem(this._array, i, (() {
            final E? temp_8960 = fillValue;
            return temp_8960 == null ? temp_8960 as E : temp_8960;
          })());
        }
      }
    }
  ...
  Iterable<E> getRange(int start, int end) {
    {
      return CppList<E>.from(
          Iterable<dynamic?>.generate((end - start), (int i) {
  ...
  List<E> sublist(int start, [int? end = null]) {
    {
      ...
      return CppList<E>.from(
          Iterable<dynamic?>.generate((endIndex - start), (int i) {
        return CppApi.cppGetPointerArrayItem(this._array, (start + i));
      }));
    }
  }
...
class CppSet<E> extends CppIterable<E> implements Set<E> {
  ...
  CppSet.fromCppArray(CppUserData array)
      : _list = CppList<E>.fromCppArray(array),
        super() {
    ;
  }

  CppSet([int capacity = 4])
      : _list = CppList<E>(0, capacity),
        super() {
    ;
  }
...
class CppMap<K, V> implements Map<K, V> {
  ...
  CppMap.fromCppArray(CppUserData array)
      : _list = CppList<MapEntry<K, V>>.fromCppArray(array),
        super() {
    ;
  }

  CppMap([int capacity = 4])
      : _list = CppList<MapEntry<K, V>>(0, capacity),
        super() {
    ;
  }
  ...
  factory CppMap.fromIterable(Iterable<dynamic?> iterable,
      {K Function(dynamic?)? key = null, V Function(dynamic?)? value = null}) {
    {
      CppMap<K, V> map = CppMap<K, V>();
      {
        ...
        for (; _sync_for_iterator.moveNext();) {
          {
            ...
            {
              dynamic? k = ((() {
                    final K Function(dynamic?)? temp_22404_5569 = key;
                    return temp_22404_5569 == null
                        ? null
                        : temp_22404_5569(element);
                  })()) ??
                  (element);
              dynamic? v = ((() {
                    final V Function(dynamic?)? temp_22449_5579 = value;
                    return temp_22449_5579 == null
                        ? null
                        : temp_22449_5579(element);
                  })()) ??
                  (element);
              map[k as K] = v as V;
            }
  ...
  void addAll(Map<K, V> other) {
    {
      other.forEach((K k, V v) {
        return (() {
          final K temp_23521_5794 = k;
          return (() {
            final V temp_23527_5796 = v;
            return (() {
              this[temp_23521_5794] = temp_23527_5796;
              temp_23527_5796;
            })();
          })();
        })();
  ...
  Iterable<K> get keys {
    return this._list.map((MapEntry<K, V> e) {
      return e.key;
    });
  }
      ...
      for (int i = 0; (i < this._list.length); i = (i + 1)) {
        {
          MapEntry<K, V> entry = this._list[i];
          this._list[i] =
              MapEntry<K, V>(entry.key, update(entry.key, entry.value));
        }
      }
    }
  }
  ...
  String toString() {
    {
      ...
      if (iterator.moveNext()) {
        buffer.write((iterator.current.key).toString() +
            ": " +
  ...
  E get last {
    {
      ...
      return (() {
        final E? temp_9168 = result;
        return temp_9168 == null ? temp_9168 as E : temp_9168;
      })();
    }
  }
  ...
  E lastWhere(bool Function(E) test, {E Function()? orElse = null}) {
    {
      ...
      if (found)
        return (() {
          final E? temp_9176 = result;
          return temp_9176 == null ? temp_9176 as E : temp_9176;
        })();
      if (!(orElse == null)) return orElse();
      throw StateError("No element");
    }
  ...
  E singleWhere(bool Function(E) test, {E Function()? orElse = null}) {
    {
      ...
      if (found)
        return (() {
          final E? temp_9184 = result;
          return temp_9184 == null ? temp_9184 as E : temp_9184;
        })();
      if (!(orElse == null)) return orElse();
      throw StateError("No element");
    }
...
class CppMappedIterable<S, T> extends CppIterable<T> {
  ...
  CppMappedIterable(Iterable<S> _source, T Function(S) _f)
      : _source = _source,
        _f = _f,
        super() {
    ;
...
class CppMappedIterator<S, T> extends CppIterator<T> {
  ...
  late T Function(S) _f;
  CppMappedIterator(Iterator<S> _iterator, T Function(S) _f)
      : _iterator = _iterator,
        _f = _f,
        super() {
    ;
  ...
  T get current {
    return (() {
      final T? temp_9192 = this._current;
      return temp_9192 == null ? temp_9192 as T : temp_9192;
    })();
  }
  ...
  bool moveNext() {
    {
      if (this._iterator.moveNext()) {
        this._current = (() {
          final S temp_6672_7183 = this._iterator.current;
          return this._f(temp_6672_7183);
        })();
        return true;
      }
      return false;
...
class CppWhereIterable<E> extends CppIterable<E> {
  ...
  CppWhereIterable(Iterable<E> _source, bool Function(E) _test)
      : _source = _source,
        _test = _test,
        super() {
    ;
...
class CppWhereIterator<E> extends CppIterator<E> {
  ...
  late bool Function(E) _test;
  CppWhereIterator(Iterator<E> _iterator, bool Function(E) _test)
      : _iterator = _iterator,
        _test = _test,
        super() {
    ;
  ...
  bool moveNext() {
    {
      while (this._iterator.moveNext()) {
        if ((() {
          final E temp_7471_7269 = this._iterator.current;
          return this._test(temp_7471_7269);
        })()) {
          return true;
        }
      }
...
class CppExpandIterable<S, T> extends CppIterable<T> {
  ...
  CppExpandIterable(Iterable<S> _source, Iterable<T> Function(S) _f)
      : _source = _source,
        _f = _f,
        super() {
    ;
...
class CppExpandIterator<S, T> extends CppIterator<T> {
  ...
  late Iterator<S> _iterator;
  late Iterable<T> Function(S) _f;
  CppExpandIterator(Iterator<S> _iterator, Iterable<T> Function(S) _f)
      : _iterator = _iterator,
        _f = _f,
        super() {
    ;
  ...
  bool moveNext() {
    {
      while (true) {
        ...
        this._currentIterator = (() {
          final S temp_9233_7450 = this._iterator.current;
          return this._f(temp_9233_7450);
        })()
            .iterator;
      }
    }
...
class CppTakeWhileIterable<E> extends CppIterable<E> {
  late Iterable<E> _source;
  late bool Function(E) _test;
  CppTakeWhileIterable(Iterable<E> _source, bool Function(E) _test)
      : _source = _source,
        _test = _test,
        super() {
    ;
...
class CppTakeWhileIterator<E> extends CppIterator<E> {
  ...
  late Iterator<E> _iterator;
  late bool Function(E) _test;
  CppTakeWhileIterator(Iterator<E> _iterator, bool Function(E) _test)
      : _iterator = _iterator,
        _test = _test,
        super() {
    ;
  ...
  bool moveNext() {
    {
      ...
      if (this._iterator.moveNext()) {
        if ((() {
          final E temp_10824_7631 = this._iterator.current;
          return this._test(temp_10824_7631);
        })()) {
          return true;
        }
        this._finished = true;
...
class CppSkipWhileIterable<E> extends CppIterable<E> {
  late Iterable<E> _source;
  late bool Function(E) _test;
  CppSkipWhileIterable(Iterable<E> _source, bool Function(E) _test)
      : _source = _source,
        _test = _test,
        super() {
    ;
...
class CppSkipWhileIterator<E> extends CppIterator<E> {
  ...
  late Iterator<E> _iterator;
  late bool Function(E) _test;
  CppSkipWhileIterator(Iterator<E> _iterator, bool Function(E) _test)
      : _iterator = _iterator,
        _test = _test,
        super() {
    ;
  ...
  bool moveNext() {
    {
      if (!(this._skipped)) {
        while (this._iterator.moveNext()) {
          if (!((() {
            final E temp_12510_7833 = this._iterator.current;
            return this._test(temp_12510_7833);
          })())) {
            this._skipped = true;
            return true;
          }
...
class _CppGenerateIterable<E> extends CppIterable<E> {
  ...
  _CppGenerateIterable(int _count, E Function(int) _generator)
      : _count = _count,
...
class _CppGenerateIterator<E> extends CppIterator<E> {
  ...
  late int _count;
  late E Function(int) _generator;
  _CppGenerateIterator(int _count, E Function(int) _generator)
      : _count = _count,
        _generator = _generator,
        super() {
    ;
  ...
  E get current {
    return (() {
      final E? temp_9200 = this._current;
      return temp_9200 == null ? temp_9200 as E : temp_9200;
    })();
  }
  ...
  bool moveNext() {
    {
      if ((this._index < this._count)) {
        this._current = (() {
          final int temp_15700_8139 = (() {
            final int temp_15700_8107 = this._index;
            return (() {
              final int temp_15694_8112 = this._index = (temp_15700_8107 + 1);
              return temp_15700_8107;
            })();
          })();
          return this._generator(temp_15700_8139);
        })();
        return true;
      }
      return false;
...
class CppStringBuffer implements StringBuffer {
  ...
  CppStringBuffer([Object content = ""])
      : _parts = (() {
          final CppList<String> temp_246_8246 = CppList<String>(0, 16);
          return (() {
  ...
  int get length {
    {
      return this._parts.fold(0, (int sum, String part) {
...
void testIterableMethods() {
  {
    ...
    assert(iterableList.any((int element) {
      return (element > 3);
    }));
    assert(!(iterableList.every((int element) {
      return (element < 3);
    })));
    Iterable<int> mappedList = iterableList.map((int e) {
      return (e * 2);
    });
    assert(mappedList.toList().toString() == [2, 4, 6, 8, 10].toString());
    Iterable<int> filteredList = iterableList.where((int e) {
      return (e % 2) == 0;
    });
    ...
    List<int> list = List<int>.generate(10, (int index) {
      return index;
    });
    list.add(11);
    print(list.toString());
