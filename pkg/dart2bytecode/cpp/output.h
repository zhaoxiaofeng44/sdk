...
static void fillRange(Object* cppThis, Int * start, Int * end, Object * fillValue);
...
static void replaceRange(Object* cppThis, Int * start, Int * end, Object * replacements);

static void retainWhere(Object* cppThis, Function * test);

static void setAll(Object* cppThis, Int * index, Object * iterable);

static void setRange(Object* cppThis, Int * start, Int * end, Object * iterable, Int * skipCount);

static void shuffle(Object* cppThis, Object * random);

static void sort(Object* cppThis, Function * compare);

static void _quickSort(Object* cppThis, Int * low, Int * high, Function * compare);

static Int * _partition(Object* cppThis, Int * low, Int * high, Function * compare);
...
static Object * update(Object* cppThis, Object * key, Function * update, Function * ifAbsent);
...
static void cppSet__partsCodeUnitsSinceCompaction(Object* cppThis, Int * value);
...
static void _insertionSort(Object * a, Int * left, Int * right, Function * compare);

static void _dualPivotQuicksort(Object * a, Int * left, Int * right, Function * compare);
...
static Object* cppCtr_value(Object* cppThis, Object * value, String * name, Object * message);
...
static Object* cppCtr_value(Object* cppThis, Num * value, String * name, String * message);

static Object* cppCtr_range(Object* cppThis, Num * invalidValue, Int * minValue, Int * maxValue, String * name, String * message);

static Num * cppGet_invalidValue(Object* cppThis);

static Object * index(Int * index, Object * indexable, String * name, String * message, Int * length);
...
class IndexError {
public:
static Object* cppCtr_(Object* cppThis, Int * invalidValue, Object * indexable, String * name, String * message, Int * length);

static Object* cppCtr_withLength(Object* cppThis, Int * invalidValue, Int * length, Object * indexable, String * name, String * message);
