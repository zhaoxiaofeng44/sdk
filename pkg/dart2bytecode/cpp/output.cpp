...
CyBase* CyBase::cppNew() {
  auto ptr = (CyBase*)malloc(sizeof(CyBase));
  return ptr;
}

//  library file:///Users/alsc/MyProject/sdk/mydart/sdk/pkg/dart2bytecode/test/hello.dart
CyFather* CyFather::cppCtr_() {
  this->b = Int::cppNew(2);
  this->base = CyBase::cppNew()->cppCtr_(Int::cppNew(3));

  return this;
}

CyFather* CyFather::cppCtr_ee() {
  this->b = Int::cppNew(2);
  this->base = CyBase::cppNew()->cppCtr_(Int::cppNew(3));
...
void CyFather::myTest() {
  print(String::cpp_add(
      String::cpp_add(this->base->cppGet_runtimeType()->toString(),
                      String::cppNew("", sizeof(""))),
      Int::toString(this->b)));
}

CyFather* CyFather::cppNew() {
  auto ptr = (CyFather*)malloc(sizeof(CyFather));
  return ptr;
}

//  library file:///Users/alsc/MyProject/sdk/mydart/sdk/pkg/dart2bytecode/test/hello.dart
CyChild* CyChild::cppCtr_() {
  this->c = Int::cppNew(2);
...
void CyChild::myTest() {
  CyChild* t = ([&](CyChild* cppLet_0) {
    ...
    cppLet_0->myTest();
    return cppLet_0;
  }(CyChild::cppNew()->cppCtr_()));
  print(String::cppNew("Gggg", sizeof("Gggg")));
}

CyChild* CyChild::cppNew() {
  auto ptr = (CyChild*)malloc(sizeof(CyChild));
  return ptr;
}
...
CyComplexTest* CyComplexTest::cppCtr_() {
  ...
  print(String::cpp_add(String::cppNew("ComplexTest initialized",
                                       sizeof("ComplexTest initialized")),
                        Int::toString(child->c)));
  return this;
}
...
void CyComplexTest::testConditionals() {
  ...
  } else if ((Num::cpp_lessThan(x, y))->getValue()) {
    print(String::cppNew("x is less than y", sizeof("x is less than y")));
  } else {
    print(String::cppNew("x is equal to y", sizeof("x is equal to y")));
  }
  String* result = (Num::cpp_greaterThan(x, y))->getValue()
                       ? String::cppNew("x is greater", sizeof("x is greater"))
                       : String::cppNew("y is greater or equal",
                                        sizeof("y is greater or equal"));
  print(String::cpp_add(cppToString(String::cppNew("Ternary result: ",
                                                   sizeof("Ternary result: "))),
                        cppToString(result)));
  String* nullableStr = nullptr;
  print(String::cpp_add(
      cppToString(String::cppNew("Null-aware: ", sizeof("Null-aware: "))),
      cppToString(([&](String* cppLet_0) {
        return (Bool::cppNew(cppLet_0 == nullptr))->getValue()
                   ? String::cppNew("Default value", sizeof("Default value"))
                   : cppLet_0;
      }(nullableStr)))));
}
...
void CyComplexTest::testSwitch(Int* value) {
  do {
    ...
    { print(String::cppNew("Unknown number", sizeof("Unknown number"))); }
  } while (0);
}

void CyComplexTest::testLoops() {
  print(String::cppNew("For-in loop:", sizeof("For-in loop:")));
  List* list = CppNewList(Int::cppNew(1), Int::cppNew(2), Int::cppNew(3),
                          Int::cppNew(4), Int::cppNew(5));
  {
    Iterator* $sync_for_iterator = list->cppGet_iterator();
    {
      while (($sync_for_iterator->moveNext())->getValue()) {
        {
          Int* item =
              reinterpret_cast<Int*>($sync_for_iterator->cppGet_current());
          { print(item); }
        }
      }
    }
...
CyComplexTest* CyComplexTest::cppNew() {
  auto ptr = (CyComplexTest*)malloc(sizeof(CyComplexTest));
  return ptr;
}

//  library file:///Users/alsc/MyProject/sdk/mydart/sdk/pkg/dart2bytecode/test/list.dart
CppPointerArray* CppPointerArray::cppCtr_(Int* _length, void** data) {
  this->_length = _length;
  this->_data = ([&](void** cppLet_0) {
    return (Bool::cppNew(cppLet_0 == nullptr))->getValue()
...
void CppPointerArray::setItem(Int* index, Object* value) {
   CppPointerArray::cppSetPointerArrayItem(this->_data, index, value);
}


CppPointerArray* CppPointerArray::cppNew() {
  auto ptr = (CppPointerArray*)malloc(sizeof(CppPointerArray));
  return ptr;
}

//  library file:///Users/alsc/MyProject/sdk/mydart/sdk/pkg/dart2bytecode/test/list.dart
CppByteArray* CppByteArray::cppCtr_(Int* _length, void** data) {
  this->_length = _length;
  this->_data = ([&](void** cppLet_0) {
    return (Bool::cppNew(cppLet_0 == nullptr))->getValue()
...
void CppByteArray::setItem(Int* index, Int* value) {
  CppByteArray::cppSetByteArrayItem(this->_data, index, value);
}

CppByteArray* CppByteArray::cppNew() {
  auto ptr = (CppByteArray*)malloc(sizeof(CppByteArray));
  return ptr;
}
...
String* CppList::toString() {
  ...
  CppStringBuffer* buffer =
      CppStringBuffer::cppNew()->cppCtr_(String::cppNew("[", sizeof("[")));
  buffer->write(this->_array->getItem(Int::cppNew(0)));
  {
    Int* i = Int::cppNew(1);
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
...
CppList* CppList::cppCtr_fromCppArray(CppPointerArray* array) {
  this->_length = array->cppGet_length();
  this->_array = array;

  return this;
}

CppList* CppList::cppCtr_(Int* length, Int* capacity) {
  this->_length = length;
  this->_array = CppPointerArray::cppNew()->cppCtr_(length, nullptr);

  return this;
}

Int* CppList::_getSuggestCapacity(Int* newLen) {
  return (Num::cpp_greaterThan(newLen, Int::cppNew(256)))->getValue()
             ? newLen
             : Num::toInt(
...
void CppList::ensureCapacity(Int* newLen) {
  if ((Num::cpp_greaterThan(newLen, this->_array->cppGet_length()))
          ->getValue()) {
    CppPointerArray* newArray = CppPointerArray::cppNew()->cppCtr_(
        CppList::_getSuggestCapacity(newLen), nullptr);
    {
      Int* i = Int::cppNew(0);
      while (
          (Num::cpp_lessThan(i, this->_array->cppGet_length()))->getValue()) {
...
Bool* CppList::any(Function* test) {
  {
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        if ((cppApply<Bool*>(
                 test, reinterpret_cast<Object*>(this->_array->getItem(i))))
                ->getValue())
...
Iterable* CppList::expand(Function* toElements) {
  List* result = CppNewList(Int::cppNew(0));
  {
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        result->addAll(cppApply<Iterable*>(
            toElements, reinterpret_cast<Object*>(this->_array->getItem(i))));
      }
      i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
    }
  }
...
Object* CppList::fold(Object* initialValue, Function* combine) {
  Object* value = initialValue;
  {
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        value = reinterpret_cast<Object*>(cppApply<Object*>(
            combine, value,
            reinterpret_cast<Object*>(this->_array->getItem(i))));
      }
      i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
    }
  }
...
Object* CppList::cppGet_last() {
  ...
  return reinterpret_cast<Object*>(
      this->_array->getItem(Num::cpp_subtract(this->_length, Int::cppNew(1))));
}
...
String* CppList::join(String* separator) {
  if ((Object::equals(this->_length, Int::cppNew(0)))->getValue())
    return String::cppNew("", sizeof(""));
  return CppList::cppJoinListString(this->_array->_data, this->_length,
                                    separator);
}
...
Object* CppList::lastWhere(Function* test, Function* orElse) {
  {
    Int* i = Num::cpp_subtract(this->_length, Int::cppNew(1));
    while ((Num::cpp_greaterThanOrEqual(i, Int::cppNew(0)))->getValue()) {
      {
        if ((cppApply<Bool*>(
                 test, reinterpret_cast<Object*>(this->_array->getItem(i))))
                ->getValue())
...
Iterable* CppList::map(Function* toElement) {
  return Iterable::generate(
      this->_length, new LambdaWrapper<Object*, Int*>([&](Int* i) -> Object* {
        return cppApply<Object*>(
            toElement, reinterpret_cast<Object*>(this->_array->getItem(i)));
      }));
}
...
Object* CppList::reduce(Function* combine) {
  if ((Object::equals(this->_length, Int::cppNew(0)))->getValue())
    throw "ConstructorInvocation(new StateError(No element))";
  Object* value =
      reinterpret_cast<Object*>(this->_array->getItem(Int::cppNew(0)));
  {
    Int* i = Int::cppNew(1);
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
...
Iterable* CppList::take(Int* count) {
  ...
  return Iterable::generate(
      (Num::cpp_lessThan(count, this->_length))->getValue() ? count
                                                            : this->_length,
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        ...
        if ((Bool::cppNew(reinterpret_cast<Object*>(element) == nullptr))
                ->getValue()) {
          result->add(element);
        }
      }
...
Object* CppList::singleWhere(Function* test, Function* orElse) {
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        if ((cppApply<Bool*>(
          ...
          if ((found)->getValue())
            throw "ConstructorInvocation(new StateError(Too many elements))";
          result = reinterpret_cast<Object*>(
              reinterpret_cast<Object*>(this->_array->getItem(i)));
  ...
  if ((found)->getValue()) return result;
  if ((Bool::cpp_not(Bool::cppNew(orElse == nullptr)))->getValue())
    return cppApply<Object*>(orElse);
  throw "ConstructorInvocation(new StateError(No element))";
}
...
Iterable* CppList::skip(Int* count) {
  if ((Num::cpp_lessThan(count, Int::cppNew(0)))->getValue())
    throw "ConstructorInvocation(new ArgumentError(Count must be positive))";
  return Iterable::generate(
      (Num::cpp_greaterThan(Num::cpp_subtract(this->_length, count),
                            Int::cppNew(0)))
              ->getValue()
          ? Num::cpp_subtract(this->_length, count)
          : Int::cppNew(0),
      new LambdaWrapper<Object*, Int*>([&](Int* i) -> Object* {
        return reinterpret_cast<Object*>(
            this->_array->getItem(Num::cpp_add(count, i)));
      }));
}
    ...
    while ((Num::cpp_lessThan(i, this->_length))->getValue()) {
      {
        if ((Bool::cpp_not(cppApply<Bool*>(
          ...
          break;
        skipCount =
            reinterpret_cast<Int*>(Num::cpp_add(skipCount, Int::cppNew(1)));
      }
      i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
    }
  }
  return Iterable::generate(
      Num::cpp_subtract(this->_length, skipCount),
      new LambdaWrapper<Object*, Int*>([&](Int* i) -> Object* {
        return reinterpret_cast<Object*>(
            this->_array->getItem(Num::cpp_add(skipCount, i)));
      }));
}

CppList* CppList::cppNew() {
  auto ptr = (CppList*)malloc(sizeof(CppList));
  return ptr;
}

//  library file:///Users/alsc/MyProject/sdk/mydart/sdk/pkg/dart2bytecode/test/list.dart
_CppListIterator* _CppListIterator::cppCtr_(CppList* _list) {
  this->_list = _list;

  return this;
}

_CppListIterator* _CppListIterator::cppNew() {
  auto ptr = (_CppListIterator*)malloc(sizeof(_CppListIterator));
  return ptr;
}
...
CppSet* CppSet::cppCtr_fromCppArray(CppPointerArray* array) {
  this->_list = CppList::cppNew()->cppCtr_fromCppArray(array);

  return this;
}

CppSet* CppSet::cppCtr_(Int* capacity) {
  this->_list = CppList::cppNew()->cppCtr_(Int::cppNew(0), capacity);
      ...
      while (($sync_for_iterator->moveNext())->getValue()) {
        {
          Object* element = $sync_for_iterator->cppGet_current();
          {
            if ((cppApply<Bool*>(test, element))->getValue()) return element;
          }
        }
      }
    }
      ...
      while (($sync_for_iterator->moveNext())->getValue()) {
        {
          Object* element = $sync_for_iterator->cppGet_current();
          {
            value = reinterpret_cast<Object*>(
                cppApply<Object*>(combine, value, element));
          }
        }
      }
    }
...
Object* CppSet::cppGet_single() {
  if ((this->_list->cppGet_isEmpty())->getValue())
    throw "ConstructorInvocation(new StateError(No element))";
  if ((Num::cpp_greaterThan(this->_list->cppGet_length(), Int::cppNew(1)))
          ->getValue())
    throw "ConstructorInvocation(new StateError(Too many elements))";
...
Object* CppSet::lastWhere(Function* test, Function* orElse) {
  {
    Int* i = Num::cpp_subtract(this->_list->cppGet_length(), Int::cppNew(1));
    while ((Num::cpp_greaterThanOrEqual(i, Int::cppNew(0)))->getValue()) {
      {
...
Object* CppSet::reduce(Function* combine) {
  ...
  {
    Int* i = Int::cppNew(1);
    while ((Num::cpp_lessThan(i, this->_list->cppGet_length()))->getValue()) {
      {
        value = reinterpret_cast<Object*>(
            cppApply<Object*>(combine, value, this->_list->cpp_subscript(i)));
      }
      i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
    }
  }
...
CppSet* CppSet::cppNew() {
  auto ptr = (CppSet*)malloc(sizeof(CppSet));
  return ptr;
}
...
String* CppMap::toString() {
  ...
  Iterator* iterator = this->_list->cppGet_iterator();
  if ((iterator->moveNext())->getValue()) {
    buffer->write(String::cpp_add(
        String::cpp_add(
            cppToString(
                reinterpret_cast<MapEntry*>(iterator->cppGet_current())->key),
            cppToString(String::cppNew(": ", sizeof(": ")))),
        cppToString(
            reinterpret_cast<MapEntry*>(iterator->cppGet_current())->value)));
    while ((iterator->moveNext())->getValue()) {
      buffer->write(String::cpp_add(
          String::cpp_add(
              String::cpp_add(cppToString(String::cppNew(", ", sizeof(", "))),
                              cppToString(reinterpret_cast<MapEntry*>(
                                              iterator->cppGet_current())
                                              ->key)),
              cppToString(String::cppNew(": ", sizeof(": ")))),
          cppToString(
              reinterpret_cast<MapEntry*>(iterator->cppGet_current())->value)));
...
CppMap* CppMap::cppCtr_fromCppArray(CppPointerArray* array) {
  this->_list = CppList::cppNew()->cppCtr_fromCppArray(array);

  return this;
}

CppMap* CppMap::cppCtr_(Int* capacity) {
  this->_list = CppList::cppNew()->cppCtr_(Int::cppNew(0), capacity);

  return this;
}

CppMap* CppMap::cppNew() {
  auto ptr = (CppMap*)malloc(sizeof(CppMap));
  return ptr;
}
...
CppStringBuffer* CppStringBuffer::cppCtr_() {
  this->_parts = CppList::cppNew()->cppCtr_(Int::cppNew(0), Int::cppNew(16));
...
void CppStringBuffer::writeAll(Iterable* objects, String* separator) {
  ...
  if ((iterator->moveNext())->getValue()) {
    this->_parts->add(
        reinterpret_cast<Object*>(iterator->cppGet_current())->toString());
    while ((iterator->moveNext())->getValue()) {
...
void CppStringBuffer::writeln(Object* obj) {
  this->_parts->add(obj->toString());
  this->_parts->add(String::cppNew("",sizeof("")));
}
...
Int* CppStringBuffer::cppGet_length() {
  return reinterpret_cast<Int*>(this->_parts->fold(
      Int::cppNew(0), new LambdaWrapper<Int*, Int*, String*>(
...
CppStringBuffer* CppStringBuffer::cppNew() {
  auto ptr = (CppStringBuffer*)malloc(sizeof(CppStringBuffer));
  return ptr;
}
...
CppWasmMap* CppWasmMap::cppNew() {
  auto ptr = (CppWasmMap*)malloc(sizeof(CppWasmMap));
  return ptr;
}
...
HideEfficientLengthIterable* HideEfficientLengthIterable::cppNew() {
  auto ptr =
      (HideEfficientLengthIterable*)malloc(sizeof(HideEfficientLengthIterable));
  return ptr;
}

//  dart._internal
SubListIterable* SubListIterable::cppCtr_(Iterable* _iterable,
                                          Int* _start,
                                          Int* _endOrLength) {
  ...
  RangeError::checkNotNegative(
      this->_start, String::cppNew("start", sizeof("start")), nullptr);
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cpp_not(Bool::cppNew(endOrLength == nullptr)))->getValue()) {
    RangeError::checkNotNegative(endOrLength,
                                 String::cppNew("end", sizeof("end")), nullptr);
...
List* SubListIterable::toList(Bool* growable) {
  ...
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cpp_not(Bool::cppNew(endOrLength == nullptr)) &&
       Num::cpp_lessThan(endOrLength, end))
          ->getValue())
  ...
  List* result =
      List::filled(length, this->_iterable->elementAt(start), growable);
  {
    Int* i = Int::cppNew(1);
    while ((Num::cpp_lessThan(i, length))->getValue()) {
      {
        result->cpp_subscriptAssign(
            i, this->_iterable->elementAt(Num::cpp_add(start, i)));
        if ((Num::cpp_lessThan(this->_iterable->cppGet_length(), end))
                ->getValue())
...
Int* SubListIterable::cppGet_length() {
  ...
  if ((Num::cpp_greaterThanOrEqual(this->_start, length))->getValue())
    return Int::cppNew(0);
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cppNew(endOrLength == nullptr) ||
       Num::cpp_greaterThanOrEqual(endOrLength, length))
          ->getValue()) {
...
Iterable* SubListIterable::take(Int* count) {
  RangeError::checkNotNegative(count, String::cppNew("count", sizeof("count")),
                               nullptr);
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cppNew(endOrLength == nullptr))->getValue()) {
    return SubListIterable::cppNew()->cppCtr_(
        this->_iterable, this->_start, Num::cpp_add(this->_start, count));
  } else {
    Int* newEnd = Num::cpp_add(this->_start, count);
    if ((Num::cpp_lessThan(endOrLength, newEnd))->getValue()) return this;
    return SubListIterable::cppNew()->cppCtr_(this->_iterable, this->_start,
                                              newEnd);
  }
}
...
Iterable* SubListIterable::skip(Int* count) {
  ...
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cpp_not(Bool::cppNew(endOrLength == nullptr)) &&
       Num::cpp_greaterThanOrEqual(newStart, endOrLength))
          ->getValue()) {
    return EmptyIterable::cppNew()->cppCtr_();
  }
  return SubListIterable::cppNew()->cppCtr_(this->_iterable, newStart,
                                            this->_endOrLength);
}

Object* SubListIterable::elementAt(Int* index) {
  Int* realIndex = Num::cpp_add(this->cppGet__startIndex(), index);
  if ((Num::cpp_lessThan(index, Int::cppNew(0)) ||
       Num::cpp_greaterThanOrEqual(realIndex, this->cppGet__endIndex()))
          ->getValue()) {
...
Int* SubListIterable::cppGet__endIndex() {
  ...
  Int* endOrLength = this->_endOrLength;
  if ((Bool::cppNew(endOrLength == nullptr) ||
       Num::cpp_greaterThan(endOrLength, length))
          ->getValue())
    return length;
  return endOrLength;
}
...
Int* SubListIterable::cppGet__startIndex() {
  Int* length = this->_iterable->cppGet_length();
  if ((Num::cpp_greaterThan(this->_start, length))->getValue()) return length;
  return this->_start;
}

SubListIterable* SubListIterable::cppNew() {
  auto ptr = (SubListIterable*)malloc(sizeof(SubListIterable));
  return ptr;
}

//  dart._internal
ListIterator* ListIterator::cppCtr_(Iterable* iterable) {
  this->_iterable = iterable;
  this->_length = iterable->cppGet_length();
  this->_index = Int::cppNew(0);

  return this;
}

ListIterator* ListIterator::cppNew() {
  auto ptr = (ListIterator*)malloc(sizeof(ListIterator));
  return ptr;
}

//  dart._internal
EfficientLengthMappedIterable* EfficientLengthMappedIterable::cppCtr_(
    Iterable* iterable,
    Function* function) {
  return this;
}

EfficientLengthMappedIterable* EfficientLengthMappedIterable::cppNew() {
  auto ptr = (EfficientLengthMappedIterable*)malloc(
      sizeof(EfficientLengthMappedIterable));
  return ptr;
}

//  dart._internal
MappedListIterable* MappedListIterable::cppCtr_(Iterable* _source,
                                                Function* _f) {
...
Object* MappedListIterable::elementAt(Int* index) {
  return ([&](Object* cppLet_0) {
    return cppApply<Object*>(this->_f, cppLet_0);
  }(this->_source->elementAt(index)));
}

MappedListIterable* MappedListIterable::cppNew() {
  auto ptr = (MappedListIterable*)malloc(sizeof(MappedListIterable));
  return ptr;
}

//  dart._internal
WhereIterable* WhereIterable::cppCtr_(Iterable* _iterable, Function* _f) {
  this->_iterable = _iterable;
  this->_f = _f;
...
Iterator* WhereIterable::cppGet_iterator() {
  return WhereIterator::cppNew()->cppCtr_(this->_iterable->cppGet_iterator(),
                                          this->_f);
}
...
WhereIterable* WhereIterable::cppNew() {
  auto ptr = (WhereIterable*)malloc(sizeof(WhereIterable));
  return ptr;
}

//  dart._internal
ExpandIterable* ExpandIterable::cppCtr_(Iterable* _iterable, Function* _f) {
  this->_iterable = _iterable;
  this->_f = _f;
...
Iterator* ExpandIterable::cppGet_iterator() {
  return ExpandIterator::cppNew()->cppCtr_(this->_iterable->cppGet_iterator(),
                                           this->_f);
}

ExpandIterable* ExpandIterable::cppNew() {
  auto ptr = (ExpandIterable*)malloc(sizeof(ExpandIterable));
  return ptr;
}

//  dart._internal
Iterator* TakeIterable::cppGet_iterator() {
  return TakeIterator::cppNew()->cppCtr_(this->_iterable->cppGet_iterator(),
                                         this->_takeCount);
}

TakeIterable* TakeIterable::cppCtr__(Iterable* _iterable, Int* _takeCount) {
  this->_iterable = _iterable;
...
TakeIterable* TakeIterable::cppEpt_(Iterable* iterable, Int* takeCount) {
  ArgumentError::checkNotNull(takeCount,
                              String::cppNew("takeCount", sizeof("takeCount")));
  RangeError::checkNotNegative(
      takeCount, String::cppNew("takeCount", sizeof("takeCount")), nullptr);
  if ((Bool::cppNew(reinterpret_cast<EfficientLengthIterable*>(iterable) ==
                    nullptr))
          ->getValue()) {
...
TakeIterable* TakeIterable::cppNew() {
  auto ptr = (TakeIterable*)malloc(sizeof(TakeIterable));
  return ptr;
}

//  dart._internal
TakeWhileIterable* TakeWhileIterable::cppCtr_(Iterable* _iterable,
                                              Function* _f) {
  this->_iterable = _iterable;
  this->_f = _f;
...
Iterator* TakeWhileIterable::cppGet_iterator() {
  return TakeWhileIterator::cppNew()->cppCtr_(
      this->_iterable->cppGet_iterator(), this->_f);
}

TakeWhileIterable* TakeWhileIterable::cppNew() {
  auto ptr = (TakeWhileIterable*)malloc(sizeof(TakeWhileIterable));
  return ptr;
}

//  dart._internal
SkipWhileIterable* SkipWhileIterable::cppCtr_(Iterable* _iterable,
                                              Function* _f) {
  this->_iterable = _iterable;
  this->_f = _f;
...
Iterator* SkipWhileIterable::cppGet_iterator() {
  return SkipWhileIterator::cppNew()->cppCtr_(
      this->_iterable->cppGet_iterator(), this->_f);
}

SkipWhileIterable* SkipWhileIterable::cppNew() {
  auto ptr = (SkipWhileIterable*)malloc(sizeof(SkipWhileIterable));
  return ptr;
}

//  dart._internal
FollowedByIterable* FollowedByIterable::cppCtr_(Iterable* _first,
                                                Iterable* _second) {
  this->_first = _first;
...
Int* FollowedByIterable::cppGet_length() {
  return Num::cpp_add(this->_first->cppGet_length(),
                      this->_second->cppGet_length());
}
...
Bool* FollowedByIterable::cppGet_isNotEmpty() {
  return this->_first->cppGet_isNotEmpty() ||
         this->_second->cppGet_isNotEmpty();
}

Object* FollowedByIterable::cppGet_first() {
  Iterator* iterator = this->_first->cppGet_iterator();
  if ((iterator->moveNext())->getValue()) return iterator->cppGet_current();
...
FollowedByIterable* FollowedByIterable::firstEfficient(
    EfficientLengthIterable* first,
    Iterable* second) {
  if ((Bool::cppNew(reinterpret_cast<EfficientLengthIterable*>(second) ==
                    nullptr))
          ->getValue()) {
...
FollowedByIterable* FollowedByIterable::cppNew() {
  auto ptr = (FollowedByIterable*)malloc(sizeof(FollowedByIterable));
  return ptr;
}

//  dart._internal
EfficientLengthFollowedByIterable* EfficientLengthFollowedByIterable::cppCtr_(
    EfficientLengthIterable* first,
...
EfficientLengthFollowedByIterable* EfficientLengthFollowedByIterable::cppNew() {
  auto ptr = (EfficientLengthFollowedByIterable*)malloc(
      sizeof(EfficientLengthFollowedByIterable));
  return ptr;
}

//  dart._internal
WhereTypeIterable* WhereTypeIterable::cppCtr_(Iterable* _source) {
  this->_source = _source;
...
WhereTypeIterable* WhereTypeIterable::cppNew() {
  auto ptr = (WhereTypeIterable*)malloc(sizeof(WhereTypeIterable));
  return ptr;
}

//  dart._internal
ReversedListIterable* ReversedListIterable::cppCtr_(Iterable* _source) {
  this->_source = _source;
...
Object* ReversedListIterable::elementAt(Int* index) {
  return this->_source->elementAt(Num::cpp_subtract(
      Num::cpp_subtract(this->_source->cppGet_length(), Int::cppNew(1)),
      index));
}

ReversedListIterable* ReversedListIterable::cppNew() {
  auto ptr = (ReversedListIterable*)malloc(sizeof(ReversedListIterable));
  return ptr;
}
...
void Sort::sort(List* a, Function* compare) {
  Sort::_doSort(a, Int::cppNew(0),
                Num::cpp_subtract(a->cppGet_length(), Int::cppNew(1)), compare);
}

void Sort::sortRange(List* a, Int* from, Int* to, Function* compare) {
  if ((Num::cpp_lessThan(from, Int::cppNew(0)) ||
       Num::cpp_greaterThan(to, a->cppGet_length()) ||
       Num::cpp_lessThan(to, from))
          ->getValue()) {
...
void Sort::_doSort(List* a, Int* left, Int* right, Function* compare) {
  if ((Num::cpp_lessThanOrEqual(Num::cpp_subtract(right, left),
                                Int::cppNew(32)))
          ->getValue()) {
...
void Sort::_insertionSort(List* a, Int* left, Int* right, Function* compare) {
  {
    Int* i = Num::cpp_add(left, Int::cppNew(1));
    while ((Num::cpp_lessThanOrEqual(i, right))->getValue()) {
      {
        Object* el = a->cpp_subscript(i);
        Int* j = i;
        while ((Num::cpp_greaterThan(j, left) &&
                Num::cpp_greaterThan(
                    cppApply<Int*>(
                        compare,
                        a->cpp_subscript(Num::cpp_subtract(j, Int::cppNew(1))),
                        el),
                    Int::cppNew(0)))
                   ->getValue()) {
          a->cpp_subscriptAssign(
              j, a->cpp_subscript(Num::cpp_subtract(j, Int::cppNew(1))));
          j = reinterpret_cast<Int*>(Num::cpp_subtract(j, Int::cppNew(1)));
        }
        a->cpp_subscriptAssign(j, el);
      }
      i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
    }
  }
...
void Sort::_dualPivotQuicksort(List* a,
                               Int* left,
                               Int* right,
                               Function* compare) {
  print("assert");
  ...
  Object* el1 = a->cpp_subscript(index1);
  Object* el2 = a->cpp_subscript(index2);
  Object* el3 = a->cpp_subscript(index3);
  Object* el4 = a->cpp_subscript(index4);
  Object* el5 = a->cpp_subscript(index5);
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el1, el2), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el1;
    el1 = reinterpret_cast<Object*>(el2);
    el2 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el4, el5), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el4;
    el4 = reinterpret_cast<Object*>(el5);
    el5 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el1, el3), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el1;
    el1 = reinterpret_cast<Object*>(el3);
    el3 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el2, el3), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el2;
    el2 = reinterpret_cast<Object*>(el3);
    el3 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el1, el4), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el1;
    el1 = reinterpret_cast<Object*>(el4);
    el4 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el3, el4), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el3;
    el3 = reinterpret_cast<Object*>(el4);
    el4 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el2, el5), Int::cppNew(0)))
          ->getValue()) {
    Object* t = el2;
    el2 = reinterpret_cast<Object*>(el5);
    el5 = reinterpret_cast<Object*>(t);
  }
  if ((Num::cpp_greaterThan(cppApply<Int*>(compare, el2, el3), Int::cppNew(0)))
          ->getValue()) {
  ...
  Object* pivot1 = el2;
  Object* pivot2 = el4;
  a->cpp_subscriptAssign(index1, el1);
  a->cpp_subscriptAssign(index3, el3);
  a->cpp_subscriptAssign(index5, el5);
  a->cpp_subscriptAssign(index2, a->cpp_subscript(left));
  a->cpp_subscriptAssign(index4, a->cpp_subscript(right));
  Int* less = Num::cpp_add(left, Int::cppNew(1));
  Int* great = Num::cpp_subtract(right, Int::cppNew(1));
  Bool* pivots_are_equal =
      Object::equals(cppApply<Int*>(compare, pivot1, pivot2), Int::cppNew(0));
  if ((pivots_are_equal)->getValue()) {
    Object* pivot = pivot1;
    {
      Int* k = less;
      while ((Num::cpp_lessThanOrEqual(k, great))->getValue()) {
        {
          Object* ak = a->cpp_subscript(k);
          Int* comp = cppApply<Int*>(compare, ak, pivot);
          if ((Object::equals(comp, Int::cppNew(0)))->getValue()) break;
          if ((Num::cpp_lessThan(comp, Int::cppNew(0)))->getValue()) {
            if ((Bool::cpp_not(Object::equals(k, less)))->getValue()) {
              a->cpp_subscriptAssign(k, a->cpp_subscript(less));
              a->cpp_subscriptAssign(less, ak);
            }
            less = reinterpret_cast<Int*>(Num::cpp_add(less, Int::cppNew(1)));
          } else {
            while ((Bool::cppNew(true))->getValue())

            {
              comp = reinterpret_cast<Int*>(
                  cppApply<Int*>(compare, a->cpp_subscript(great), pivot));
              if ((Num::cpp_greaterThan(comp, Int::cppNew(0)))->getValue()) {
                great = reinterpret_cast<Int*>(
                    Num::cpp_subtract(great, Int::cppNew(1)));
                break;
              } else if ((Num::cpp_lessThan(comp, Int::cppNew(0)))
                             ->getValue()) {
                a->cpp_subscriptAssign(k, a->cpp_subscript(less));
                a->cpp_subscriptAssign(
                    ([&](Int* cppLet_0) {
                      return ([&](Int* cppLet_0) {
                        return cppLet_0;
                      }(less = reinterpret_cast<Int*>(
                                  Num::cpp_add(cppLet_0, Int::cppNew(1)))));
                    }(less)),
                    a->cpp_subscript(great));
                a->cpp_subscriptAssign(
                    ([&](Int* cppLet_0) {
                      return ([&](Int* cppLet_0) {
                        return cppLet_0;
                      }(great = reinterpret_cast<Int*>(Num::cpp_subtract(
                                  cppLet_0, Int::cppNew(1)))));
                    }(great)),
                    ak);
                break;
              } else {
                a->cpp_subscriptAssign(k, a->cpp_subscript(great));
                a->cpp_subscriptAssign(
                    ([&](Int* cppLet_0) {
                      return ([&](Int* cppLet_0) {
                        return cppLet_0;
        ...
        k = reinterpret_cast<Int*>(Num::cpp_add(k, Int::cppNew(1)));
      }
    }
  } else {
    {
      ...
      while ((Num::cpp_lessThanOrEqual(k, great))->getValue()) {
        {
          ...
          if ((Num::cpp_lessThan(comp_pivot1, Int::cppNew(0)))->getValue()) {
            if ((Bool::cpp_not(Object::equals(k, less)))->getValue()) {
              a->cpp_subscriptAssign(k, a->cpp_subscript(less));
              a->cpp_subscriptAssign(less, ak);
            }
            ...
            if ((Num::cpp_greaterThan(comp_pivot2, Int::cppNew(0)))
                    ->getValue()) {
              while ((Bool::cppNew(true))->getValue())

              {
                Int* comp =
                    cppApply<Int*>(compare, a->cpp_subscript(great), pivot2);
                if ((Num::cpp_greaterThan(comp, Int::cppNew(0)))->getValue()) {
                  great = reinterpret_cast<Int*>(
                      Num::cpp_subtract(great, Int::cppNew(1)));
                  if ((Num::cpp_lessThan(great, k))->getValue()) break;
                  break;
                } else {
                  comp = reinterpret_cast<Int*>(
                      cppApply<Int*>(compare, a->cpp_subscript(great), pivot1));
                  if ((Num::cpp_lessThan(comp, Int::cppNew(0)))->getValue()) {
                    a->cpp_subscriptAssign(k, a->cpp_subscript(less));
                    a->cpp_subscriptAssign(
                        ([&](Int* cppLet_0) {
  ...
  a->cpp_subscriptAssign(
      left, a->cpp_subscript(Num::cpp_subtract(less, Int::cppNew(1))));
  a->cpp_subscriptAssign(Num::cpp_subtract(less, Int::cppNew(1)), pivot1);
  a->cpp_subscriptAssign(right,
                         a->cpp_subscript(Num::cpp_add(great, Int::cppNew(1))));
  a->cpp_subscriptAssign(Num::cpp_add(great, Int::cppNew(1)), pivot2);
  ...
  if ((Num::cpp_lessThan(less, index1) && Num::cpp_greaterThan(great, index5))
          ->getValue()) {
    while (
        (Object::equals(cppApply<Int*>(compare, a->cpp_subscript(less), pivot1),
                        Int::cppNew(0)))
            ->getValue()) {
      less = reinterpret_cast<Int*>(Num::cpp_add(less, Int::cppNew(1)));
    }
    while ((Object::equals(
                ...
                Int::cppNew(0)))
               ->getValue()) {
      great = reinterpret_cast<Int*>(Num::cpp_subtract(great, Int::cppNew(1)));
    }
    {
      Int* k = less;
      while ((Num::cpp_lessThanOrEqual(k, great))->getValue()) {
        {
          Object* ak = a->cpp_subscript(k);
          Int* comp_pivot1 = cppApply<Int*>(compare, ak, pivot1);
          if ((Object::equals(comp_pivot1, Int::cppNew(0)))->getValue()) {
            if ((Bool::cpp_not(Object::equals(k, less)))->getValue()) {
              a->cpp_subscriptAssign(k, a->cpp_subscript(less));
              a->cpp_subscriptAssign(less, ak);
            }
            ...
            Int* comp_pivot2 = cppApply<Int*>(compare, ak, pivot2);
            if ((Object::equals(comp_pivot2, Int::cppNew(0)))->getValue()) {
              while ((Bool::cppNew(true))->getValue())

              {
                Int* comp =
                    cppApply<Int*>(compare, a->cpp_subscript(great), pivot2);
                if ((Object::equals(comp, Int::cppNew(0)))->getValue()) {
                  great = reinterpret_cast<Int*>(
                      Num::cpp_subtract(great, Int::cppNew(1)));
                  if ((Num::cpp_lessThan(great, k))->getValue()) break;
                  break;
...
Sort* Sort::cppNew() {
  auto ptr = (Sort*)malloc(sizeof(Sort));
  return ptr;
}

//  dart.math
Random* Random::cppEpt_(Int* seed) {
  Int* state = _Random::_setupSeed((Bool::cppNew(seed == nullptr))->getValue()
                                       ? _Random::_nextSeed()
                                       : seed);
  return ([&](_Random* cppLet_0) {
    ...
    cppLet_0->_nextState();
    return cppLet_0;
  }(_Random::cppNew()->cppCtr__withState(state)));
}
...
NativeFieldWrapperClass1* NativeFieldWrapperClass1::cppNew() {
  auto ptr =
      (NativeFieldWrapperClass1*)malloc(sizeof(NativeFieldWrapperClass1));
  return ptr;
}
...
NativeFieldWrapperClass2* NativeFieldWrapperClass2::cppNew() {
  auto ptr =
      (NativeFieldWrapperClass2*)malloc(sizeof(NativeFieldWrapperClass2));
  return ptr;
}
...
NativeFieldWrapperClass3* NativeFieldWrapperClass3::cppNew() {
  auto ptr =
      (NativeFieldWrapperClass3*)malloc(sizeof(NativeFieldWrapperClass3));
  return ptr;
}
...
NativeFieldWrapperClass4* NativeFieldWrapperClass4::cppNew() {
  auto ptr =
      (NativeFieldWrapperClass4*)malloc(sizeof(NativeFieldWrapperClass4));
  return ptr;
}
...
//  dart.core
RangeError* RangeError::cppCtr_(void** message) {
  this->start = nullptr;
  this->end = nullptr;
...
RangeError* RangeError::cppCtr_value(Num* value,
                                     String* name,
                                     String* message) {
  this->start = nullptr;
  this->end = nullptr;
...
String* RangeError::cppGet__errorExplanation() {
  ...
  if ((Bool::cppNew(start == nullptr))->getValue()) {
    if ((Bool::cpp_not(Bool::cppNew(end == nullptr)))->getValue()) {
      explanation = reinterpret_cast<String*>(String::cpp_add(
          cppToString(String::cppNew(": Not less than or equal to ",
                                     sizeof(": Not less than or equal to "))),
          cppToString(end)));
    }
  } else if ((Bool::cppNew(end == nullptr))->getValue()) {
    explanation = reinterpret_cast<String*>(String::cpp_add(
        cppToString(String::cppNew(": Not greater than or equal to ",
                                   sizeof(": Not greater than or equal to "))),
        cppToString(start)));
  } else if ((Num::cpp_greaterThan(end, start))->getValue()) {
    explanation = reinterpret_cast<String*>(String::cpp_add(
        String::cpp_add(
            String::cpp_add(cppToString(String::cppNew(
                                ": Not in inclusive range ",
                                sizeof(": Not in inclusive range "))),
                            cppToString(start)),
            cppToString(String::cppNew("..", sizeof("..")))),
        cppToString(end)));
  } else if ((Num::cpp_lessThan(end, start))->getValue()) {
    explanation = reinterpret_cast<String*>(
        String::cppNew(": Valid value range is empty",
                       sizeof(": Valid value range is empty")));
  } else {
    explanation = reinterpret_cast<String*>(String::cpp_add(
        cppToString(String::cppNew(": Only valid value is ",
                                   sizeof(": Only valid value is "))),
        cppToString(start)));
  }
  return explanation;
}

RangeError* RangeError::cppCtr_range(Num* invalidValue,
                                     Int* minValue,
                                     Int* maxValue,
                                     String* name,
                                     String* message) {
...
RangeError* RangeError::index(Int* index,
                              void** indexable,
                              String* name,
                              String* message,
                              Int* length) {
...
Int* RangeError::checkValueInInterval(Int* value,
                                      ...
                                      String* name,
                                      String* message) {
  if ((Num::cpp_lessThan(value, minValue) ||
       Num::cpp_greaterThan(value, maxValue))
          ->getValue()) {
...
Unhandled expression type : DynamicGet Int* RangeError::checkValidIndex(
                                ...
                                Int* length,
                                String* message) {
  (Bool::cppNew(length == nullptr))->getValue()
      ? length = reinterpret_cast<Int*>(reinterpret_cast<Int*>())
      : nullptr;
...
Int* RangeError::checkValidRange(Int* start,
                                 ...
                                 String* endName,
                                 String* message) {
  if ((Num::cpp_greaterThan(Int::cppNew(0), start) ||
       Num::cpp_greaterThan(start, length))
          ->getValue()) {
    (Bool::cppNew(startName == nullptr))->getValue()
        ? startName = reinterpret_cast<String*>(
              String::cppNew("start", sizeof("start")))
        : nullptr;
    throw "ConstructorInvocation(new RangeError.range(start, 0, length, startName{String}, message))";
  }
  if ((Bool::cpp_not(Bool::cppNew(end == nullptr)))->getValue()) {
    if ((Num::cpp_greaterThan(start, end) || Num::cpp_greaterThan(end, length))
            ->getValue()) {
      (Bool::cppNew(endName == nullptr))->getValue()
          ? endName =
                reinterpret_cast<String*>(String::cppNew("end", sizeof("end")))
          : nullptr;
...
String* Iterable::toString() {
  return Iterable::iterableToShortString(this, String::cppNew("(", sizeof("(")),
                                         String::cppNew(")", sizeof(")")));
}
...
Iterable* Iterable::followedBy(Iterable* other) {
  Iterable* self = this;
  if ((Bool::cppNew(reinterpret_cast<EfficientLengthIterable*>(self) ==
                    nullptr))
          ->getValue()) {
...
Object* Iterable::reduce(Function* combine) {
  ...
  while ((iterator->moveNext())->getValue()) {
    value = reinterpret_cast<Object*>(
        cppApply<Object*>(combine, value, iterator->cppGet_current()));
  }
  return value;
}
...
String* Iterable::join(String* separator) {
  ...
  if ((Bool::cpp_not(iterator->moveNext()))->getValue()) return first;
  CppStringBuffer* buffer = CppStringBuffer::cppNew()->cppCtr_(first);
  if ((Bool::cppNew(separator == nullptr) || separator->cppGet_isEmpty())
          ->getValue()) {
    do {
    ...
    do {
      ([&](CppStringBuffer* cppLet_0) {
        cppLet_0->write(separator);
        cppLet_0->write(iterator->cppGet_current()->toString());
        return cppLet_0;
      }(buffer));
    } while ((iterator->moveNext())->getValue());
  }
...
Object* Iterable::elementAt(Int* index) {
  RangeError::checkNotNegative(index, String::cppNew("index", sizeof("index")),
                               nullptr);
  Iterator* iterator = this->cppGet_iterator();
  Int* skipCount = index;
  while ((iterator->moveNext())->getValue()) {
    ...
    skipCount =
        reinterpret_cast<Int*>(Num::cpp_subtract(skipCount, Int::cppNew(1)));
  }
  throw "ConstructorInvocation(new IndexError.withLength(index, index.{num.-}(skipCount), indexable: this, name: index))";
}

String* Iterable::iterableToShortString(Iterable* iterable,
                                        String* leftDelimiter,
                                        String* rightDelimiter) {
  if ((isToStringVisiting(iterable))->getValue()) {
    if ((Object::equals(leftDelimiter, String::cppNew("(", sizeof("("))) &&
         Object::equals(rightDelimiter, String::cppNew(")", sizeof(")"))))
            ->getValue()) {
      return String::cppNew("(...)", sizeof("(...)"));
    }
    return String::cpp_add(
        String::cpp_add(cppToString(leftDelimiter),
                        cppToString(String::cppNew("...", sizeof("...")))),
  ...
  return ([&](CppStringBuffer* cppLet_0) {
           cppLet_0->writeAll(parts, String::cppNew(", ", sizeof(", ")));
           cppLet_0->write(rightDelimiter);
           return cppLet_0;
         }(CppStringBuffer::cppNew()->cppCtr_(leftDelimiter)))
      ->toString();
}

String* Iterable::iterableToFullString(Iterable* iterable,
                                       String* leftDelimiter,
                                       String* rightDelimiter) {
  if ((isToStringVisiting(iterable))->getValue()) {
    return String::cpp_add(
  ...
  CppStringBuffer* buffer = CppStringBuffer::cppNew()->cppCtr_(leftDelimiter);
  ->add(iterable);
  try {
...
List* List::filled(Int* length, Object* fill, Bool* growable) {
  return (growable)->getValue() ? CppNewList(length, fill)
                                : _List::filled(length, fill);
}

List* List::from(Iterable* elements, Bool* growable) {
  if ((Bool::cppNew(reinterpret_cast<Iterable*>(elements) == nullptr))
          ->getValue()) {
  ...
  List* list = CppNewList(Int::cppNew(0));
  {
    Iterator* $sync_for_iterator = elements->cppGet_iterator();
    {
      while (($sync_for_iterator->moveNext())->getValue()) {
        {
          void** cppLet_0 =
              reinterpret_cast<void**>($sync_for_iterator->cppGet_current());
          {
  ...
  if ((growable)->getValue()) return list;
...
void List::copyRange(List* target,
                     Int* at,
                     List* source,
                     Int* start,
                     Int* end) {
  (Bool::cppNew(start == nullptr))->getValue()
      ? start = reinterpret_cast<Int*>(Int::cppNew(0))
      : nullptr;
  end = reinterpret_cast<Int*>(RangeError::checkValidRange(
      start, end, source->cppGet_length(), nullptr, nullptr, nullptr));
  if ((Bool::cppNew(end == nullptr))->getValue()) {
    throw "StringLiteral(unreachable)";
  }
  Int* length = Num::cpp_subtract(end, start);
  if ((Num::cpp_lessThan(target->cppGet_length(), Num::cpp_add(at, length)))
          ->getValue()) {
    throw "ConstructorInvocation(new ArgumentError.value(target, target, Not big enough to hold ${length} elements at position ${at}))";
  }
  if ((Bool::cpp_not(identical(source, target)) ||
       Num::cpp_greaterThanOrEqual(start, at))
          ->getValue()) {
    {
      Int* i = Int::cppNew(0);
      while ((Num::cpp_lessThan(i, length))->getValue()) {
        {
          target->cpp_subscriptAssign(
              Num::cpp_add(at, i),
              source->cpp_subscript(Num::cpp_add(start, i)));
        }
        i = reinterpret_cast<Int*>(Num::cpp_add(i, Int::cppNew(1)));
      }
    }
...
void List::writeIterable(List* target, Int* at, Iterable* source) {
  RangeError::checkValueInInterval(at, Int::cppNew(0), target->cppGet_length(),
                                   String::cppNew("at", sizeof("at")), nullptr);
  Int* index = at;
...
Map* Map::_fromLiteral(List* elements) {
  ...
  {
    Int* i = Int::cppNew(1);
    while ((Num::cpp_lessThan(i, len))->getValue()) {
      {
        map->cpp_subscriptAssign(
            reinterpret_cast<Object*>(reinterpret_cast<void**>(
                elements->cpp_subscript(Num::cpp_subtract(i, Int::cppNew(1))))),
            reinterpret_cast<Object*>(
                reinterpret_cast<void**>(elements->cpp_subscript(i))));
      }
...
String* MapEntry::toString() {
  return String::cpp_add(
      String::cpp_add(
          String::cpp_add(
              String::cpp_add(
                  cppToString(String::cppNew("MapEntry(", sizeof("MapEntry("))),
                  cppToString(this->key)),
              cppToString(String::cppNew(": ", sizeof(": ")))),
          cppToString(this->value)),
      cppToString(String::cppNew(")", sizeof(")"))));
}

MapEntry* MapEntry::cppCtr__(Object* key, Object* value) {
  this->key = key;
  this->value = value;
...
MapEntry* MapEntry::cppNew() {
  auto ptr = (MapEntry*)malloc(sizeof(MapEntry));
  return ptr;
}
...
Set* Set::unmodifiable(Iterable* elements) {
  return UnmodifiableSetView::cppNew()->cppCtr_([&] {
    Set* cppLet_0 = LinkedHashSet::of(elements);
    return cppLet_0
  }());
}
...
String* CppStringBuffer::toString() {
  ...
  return (Object::equals(this->_partsCodeUnits, Int::cppNew(0)) ||
          Bool::cppNew(localParts == nullptr))
                 ->getValue()
             ? String::cppNew("", sizeof(""))
             : _StringBase::_concatRange(localParts, Int::cppNew(0),
                                         localParts->cppGet_length());
}

CppStringBuffer* CppStringBuffer::cppCtr_(Object* content) {
  this->write(content);
  return this;
}

void CppStringBuffer::_writeString(String* str) {
  this->_consumeBuffer();
  this->_addPart(str);
}

void CppStringBuffer::_ensureCapacity(Int* n) {
  ...
  } else if ((Num::cpp_greaterThan(Num::cpp_add(this->_bufferPosition, n),
                                   localBuffer->cppGet_length()))
                 ->getValue()) {
    this->_consumeBuffer();
  }
}

void CppStringBuffer::_consumeBuffer() {
  if ((Object::equals(this->_bufferPosition, Int::cppNew(0)))->getValue())
    return;
  Bool* isLatin1 = Num::cpp_lessThanOrEqual(this->_bufferCodeUnitMagnitude,
                                            Int::cppNew(255));
  String* str =
      CppStringBuffer::_create(this->_buffer, this->_bufferPosition, isLatin1);
  this->_bufferPosition = this->_bufferCodeUnitMagnitude = Int::cppNew(0);
  this->_addPart(str);
}

void CppStringBuffer::_addPart(String* str) {
  List* localParts = this->_parts;
  Int* length = str->cppGet_length();
  this->_partsCodeUnits = Num::cpp_add(this->_partsCodeUnits, length);
  this->_partsCodeUnitsSinceCompaction =
      Num::cpp_add(this->_partsCodeUnitsSinceCompaction, length);
  if ((Bool::cppNew(localParts == nullptr))->getValue()) {
    this->_parts = ([&](_GrowableList* cppLet_0) {
      cppLet_0->add(str);
      return cppLet_0;
    }(CppNewList(Int::cppNew(10))));
  } else {
    localParts->add(str);
    Int* partsSinceCompaction = Num::cpp_subtract(localParts->cppGet_length(),
                                                  this->_partsCompactionIndex);
...
void CppStringBuffer::_compact() {
  List* localParts = this->_parts;
  if ((Num::cpp_lessThan(this->_partsCodeUnitsSinceCompaction,
                         Int::cppNew(1024)))
          ->getValue()) {
    String* compacted = _StringBase::_concatRange(
        localParts, this->_partsCompactionIndex,
        Num::cpp_add(this->_partsCompactionIndex, Int::cppNew(128)));
    localParts->cppSet_length(
        Num::cpp_subtract(localParts->cppGet_length(), Int::cppNew(128)));
...
String* CppStringBuffer::_create(Uint16List* buffer, Int* length, Bool* isLatin1) {
}
...
void CppStringBuffer::clear() {
  this->_parts = nullptr;
  this->_partsCodeUnits = this->_bufferPosition =
      this->_bufferCodeUnitMagnitude = Int::cppNew(0);
}
