...
public:
    ...
    static String *cpp_subscript(String *str, Int *index);     // [] 获取字符(返回单字符字符串)
    ...
    static Int *indexOf(String *str, String *pattern, Int *start = NULL);     // 查找索引
    static Int *lastIndexOf(String *str, String *pattern, Int *start = NULL); // 最后索引

    // 子字符串方法
    static String *substring(String *str, Int *start, Int *end = NULL); // 子字符串
    static String *substr(String *str, Int *start, Int *length = NULL); // 子字符串(按长度)
    ...
    static String *replaceFirst(String *str, String *from, String *to);                  // 替换第一个
    static String *replaceRange(String *str, Int *start, Int *end, String *replacement); // 替换范围

    // 填充方法
    static String *padLeft(String *str, Int *width, String *padding = NULL);  // 左填充
    static String *padRight(String *str, Int *width, String *padding = NULL); // 右填充
    ...
    // 分割和连接
    static String **split(String *str, String *pattern, Int *limit = NULL); // 分割字符串(返回数组)
    static String *join(String **strings, Int *count, String *separator);   // 连接字符串数组
    ...
    // 格式化
    static String *format(String *template_str, String **args, Int *argCount); // 格式化字符串
