...
class CyFather<T, A> extends CyBase {
  int b;
  CyBase base;
  CyFather()
      : b = 2,
...
class CyChild<T, A> extends CyFather<A, int> {
  int c;
  num e = 6;
  CyChild() : c = 2;
...
class CyComplexTest {
  ...
  @pragma('wasm:entry-point')
  CyComplexTest() {
    var child = new CyChild<String, int>();
    _messages.add("Initialized");
    print("ComplexTest initialized" + child.c.toString());
  }
