...
class CppPointerArray {
  ...
  // 使用函数引用，直接指向cppCreatePointerArray
  static final Function(int) createArrayRef = cppCreatePointerArray;

  // 直接调用C++函数的静态方法（正确的语法）
  @pragma("cpp:native", r"CppApi::cppCreatePointerArray")
  static dynamic createArrayDirect(int length) {
    // 这里会直接调用C++的CppApi::cppCreatePointerArray函数
    return cppCreatePointerArray(length);
  }
}
